    ...
    <Layout>
      <Container>
            ...
            <Box flex={1} pointerEvents="none">
              ...
              {mounted && (
                <Flex
                  ...
                  align="center"
                >
                  <Text letterSpacing="widest" pointerEvents="auto">
                    {t.home.role?.split("|")[0]?.trim() || "Tech Consultant"}
                  </Text>
                  <Box w="1px" h="12px" bg="gray.400" />
                  <Text letterSpacing="widest" pointerEvents="auto">
                    {t.home.role?.split("|")[1]?.trim() || "CRM Specialist"}
                  </Text>
                </Flex>
              )}
            </Box>
        ...
        <Section delay={0.1} direction="left" id="about-section">
          ...
          <Paragraph>{t.home.aboutText}</Paragraph>
        ...
        <Section delay={0.1} direction="right">
          ...
          <Paragraph>{t.home.philosophyText}</Paragraph>
        </Section>
        ...
        <Section delay={0.2} direction="left">
          ...
          <BioSection>
            ...
            <BioContent>
              ...
              — PricewaterhouseCoopers LLP (PwC), Kolkata
              <Text
                fontSize="sm"
                color="gray.600"
                _dark={{ color: "gray.400" }}
        ...
        <Section delay={0.2} direction="right">
          ...
          <BioSection>
            ...
            <BioContent>
              ...
              — Jodhpur Park Boys&apos; School, Kolkata
              <Text
                fontSize="sm"
                color="gray.600"
                _dark={{ color: "gray.400" }}
          ...
          <BioSection>
            ...
            <BioContent>
              ...
              — Andrew&apos;s High (HS) School, Kolkata
              <Text
                fontSize="sm"
                color="gray.600"
                _dark={{ color: "gray.400" }}
        ...
        <Section delay={0.3} direction="right">
          ...
          <ListRoot listStyle="none" p={0}>
            ...
            <ListItem>
              <Link
                href="https://github.com/Ankush1461"
                target="_blank"
                _hover={{ textDecoration: "none" }}
              >
                <Button variant="ghost" colorPalette="teal" size="sm">
            ...
            <ListItem>
              <Link
                href="mailto:karmakarankush1461@gmail.com"
                target="_blank"
                _hover={{ textDecoration: "none" }}
              >
                <Button variant="ghost" colorPalette="teal" size="sm">
