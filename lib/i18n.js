...
const translations = {
  en: {
    ...
    home: {
      ...
      philosophyText: "I believe that technology should be an enabler, not a bottleneck. My approach to CRM implementation focuses on 'Clean Data, Clean Logic'—ensuring that enterprise systems are not just functional, but scalable and maintainable. I bridge the gap between complex business requirements and high-performance technical implementation, always prioritizing user experience and data integrity.",
      workTitle: "Work Experience",
      pwcRole: "Associate",
      pwcDesc: "Managed and enhanced Dynamics CRM solutions for enterprise clients like Apollo Hospitals & DIEZ. Engineering robust C# plugins and Power Automate flows, leading fit-gap assessments, and cutting system delivery timelines by 15-20%. Leading client workshops to translate business needs into technical specifications.",
      eyRole: "Associate Consultant",
      eyDesc: "Implemented large-scale CRM customizations for HDFC Life & Aditya Birla Capital. Drove backend data integrity via advanced SQL and deployed complex business logic utilizing .NET (C#) and JavaScript. Optimized database queries resulting in a 30% reduction in report generation time.",
      eduTitle: "Education",
      eduBtech: "Bachelor of Technology in Computer Science and Engineering",
      eduBtechDesc: "• Grade: 8.7 / 10.0 DGPA\n• Key Coursework: Machine Learning, Artificial Intelligence, DBMS, Design & Analysis of Algorithms, Statistics, and Numerical Methods.",
      ...
      hobbiesText: "When I'm not developing CRM systems, you'll find me on the football pitch or analyzing match statistics. I am a firm believer in the discipline and teamwork that sports instill in engineering projects.",
    ...
    projects: {
      ...
      drivesafeDesc: "A high-performance computer vision system designed for road safety.",
      drivesafeHighlights: [
      ...
      drivesafeChallenges: "Achieving real-time inference on low-power CPU devices while maintaining high precision under varying lighting conditions.",
      meteordashTitle: "MeteorDash: Gesture-Controlled Browser Game",
      meteordashDesc: "An immersive browser game utilizing hand-tracking for intuitive gameplay.",
      ...
      meteordashChallenges: "Smoothing out jittery gesture detection and ensuring cross-browser performance for MediaPipe's heavy ML overhead.",
      appleTitle: "Apple iPhone 15 Series Landing Page",
      appleDesc: "A premium, high-fidelity clone focused on animations and 3D interactions.",
      appleHighlights: [
        "GSAP scroll-driven typography animations",
        "Three.js real-time 3D model interaction",
        "Pixel-perfect responsive Apple aesthetic"
      ],
      appleChallenges: "Optimizing high-poly 3D models to maintain 60FPS while scrolling through complex GSAP timelines.",
      sourceBtn: "Source",
      demoBtn: "Live Demo"
    },
    contact: {
  ...
  de: {
    ...
    home: {
      ...
      aboutText: "Microsoft zertifizierter Technologieberater mit über 2 Jahren Erfahrung bei PwC und EY. Experte für die Entwicklung datengesteuerter CRM-Lösungen und Cloud-Migrationen für große Unternehmen. Mit einem starken akademischen Hintergrund in B.Tech (Informatik) widme ich mich mit Leidenschaft der Erweiterung meines Wissens im Bereich Data Science, um leistungsstarke, datengesteuerte Systeme zu entwickeln.",
      resumeBtn: "Mein Lebenslauf",
      philosophyTitle: "Ansatz & Philosophie",
      philosophyText: "Ich glaube, dass Technologie ein Enabler sein sollte, kein Engpass. Mein Ansatz zur CRM-Implementierung konzentriert sich auf 'Saubere Daten, Saubere Logik' – um sicherzustellen, dass Unternehmenssysteme nicht nur funktionsfähig, sondern auch skalierbar und wartbar sind.",
      workTitle: "Berufserfahrung",
      pwcRole: "Associate",
      pwcDesc: "Verwaltung und Optimierung der Dynamics CRM-Lösungen für Unternehmenskunden wie Apollo Hospitals & DIEZ. Entwicklung robuster C#-Plugins und Power Automate-Flows, Leitung von Fit-Gap-Analysen und Reduzierung von Systembereitstellungszeiten um 15-20%. Leitung von Workshops zur Übersetzung von Geschäftsanforderungen in technische Spezifikationen.",
      eyRole: "Associate Consultant",
      eyDesc: "Implementierung umfangreicher CRM-Anpassungen für HDFC Life & Aditya Birla Capital. Sicherstellung der Backend-Datenintegrität durch SQL und Bereitstellung komplexer Geschäftslogik mit .NET (C#) und JavaScript. Optimierung von Abfragen zur Reduzierung der Berichtszeit um 30%.",
      eduTitle: "Ausbildung",
      eduBtech: "Bachelor of Technology in Informatik und Computertechnik",
      eduBtechDesc: "• Note: 8.7 / 10.0 DGPA\n• Wichtige Kursinhalte: Maschinelles Lernen, Künstliche Intelligenz, DBMS, Design & Analyse von Algorithmen, Statistik und numerische Methoden.",
      ...
      hobbiesText: "Wenn ich keine CRM-Systeme entwickle, finden Sie mich auf dem Fußballplatz oder bei der Analyse von Spielstatistiken. Ich glaube fest an die Disziplin und den Teamgeist des Sports.",
    ...
    projects: {
      ...
      drivesafeDesc: "Ein leistungsstarkes Computer-Vision-System für die Verkehrssicherheit.",
      drivesafeHighlights: [
        "97,24% Genauigkeit mit MobileNetV3Large",
        "Quantisiert auf 4,3 MB TFLite",
        "Latenzfreie FastAPI-WebSocket-Architektur"
      ],
      drivesafeChallenges: "Echtzeit-Inferenz auf leistungsschwachen CPU-Geräten unter wechselnden Lichtverhältnissen.",
      meteordashTitle: "MeteorDash: Gestengesteuertes Browser-Spiel",
      meteordashDesc: "Ein immersives Browser-Spiel, das Hand-Tracking für intuitives Gameplay nutzt.",
      meteordashHighlights: [
      ...
      meteordashChallenges: "Glättung der Gestenerkennung und Sicherstellung der Browserleistung trotz hoher ML-Last.",
      appleTitle: "Apple iPhone 15 Landing Page",
      appleDesc: "Ein hochwertiger Klon mit Fokus auf Animationen und 3D-Interaktionen.",
      appleHighlights: [
      ...
      appleChallenges: "Optimierung von 3D-Modellen für stabile 60FPS während komplexer GSAP-Animationen.",
      sourceBtn: "Quellcode",
      demoBtn: "Live-Demo"
    },
    contact: {
